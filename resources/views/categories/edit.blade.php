<x-layouts.app :title="__('Editar Categoría')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        <div class="bg-white dark:bg-zinc-900 rounded-xl border border-neutral-200 dark:border-neutral-700 p-8 max-w-2xl mx-auto w-full">
            <h1 class="text-3xl font-bold text-gray-800 dark:text-white mb-6">Editar Categoría</h1>
            ...
            <form action="{{ route('categories.update', $category) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-gray-500 dark:text-gray-400 text-sm mt-1">Slug actual: <strong>{{ $category->slug }}</strong></p>
                </div>
